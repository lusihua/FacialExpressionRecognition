...
parser.add_argument('--pre', '-p', default= False , help='not load pre_model accuracy')
...
trainset = CK.CK(split = 'Training', fold = opt.fold, transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=opt.bs, shuffle=True, num_workers=1)
testset = CK.CK(split = 'Testing', fold = opt.fold, transform=transform_test)
